...
A következő címkék segítségével a felhasználók számára, amely csomagokat jól használhatók a környezetükben bemutatása:
...
A csomagot a fog szerepelni a katalógusban található kompatibilis platform(ok) megtekintett keresési szűrőket a bal oldali panelen, a keresési eredmények között. Ha a csomag a Githubon, ha a csomagot, akkor is kihasználhatja a [PowerShell-galériából kompatibilitási elleni védelmét](https://img.shields.io/powershellgallery/p/:packageName.svg) 
![kompatibilitási pajzs](https://img.shields.io/powershellgallery/p/CosmosDB.svg).  
...
[SemVer](http://semver.org/) van egy nyilvános egyezmény, amely azt ismerteti, hogyan struktúra, és módosítsa, hogy a változások egyszerű értelmezését biztosítsa egy verzióját.
...
- A második szám (1.1-es 1.2) módosításai jelezheti szövegen túl szolgáltatásszintű változásakor, például új parancsmagok hozzáadása a modul
