...
---
# <a name="new-scriptfileinfo"></a>Új ScriptFileInfo

Egy olyan parancsfájlt hoz létre a metaadatok.

## <a name="description"></a>Leírás

A New-ScriptFileInfo parancsmag létrehoz egy PowerShell-parancsfájlba, beleértve a parancsfájllal kapcsolatos metaadatokat.
...
[Új ScriptFileInfo](http://go.microsoft.com/fwlink/?LinkId=619792)

## <a name="example-commands"></a>Példa parancsok

### <a name="passthru-parameter"></a>PassThru paraméter

```powershell
New-ScriptFileInfo -Description "Script file description." -PassThru
```

### <a name="new-scriptfileinfo-cmdlet"></a>Új ScriptFileInfo parancsmag
Új ScriptFileInfo parancsmag segítségével hozzon létre egy új parancsfájlt metaadatok verzióját, Guid, Szerző és leírását, például stb. 
