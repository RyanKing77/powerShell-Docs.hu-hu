...
* Az előzetes karakterlánc van megadva a moduljegyzékben PrivateData PSData szakaszában. Részletes követelményeket az előzetes karakterlánc alatt van. 
...
PowerShellGet keresés-modul, a telepítés-modul, a frissítés-modul, az előzetes elemekről foglalkozó és mentés-modul parancsokat igényel, a - AllowPrerelease jelző hozzáadása. Ha - AllowPrerelease meg van adva, előzetes elemek is fog szerepelni, ha ilyenek.
...
Modul eltávolítása eltávolítja a legújabb verzióra a modulok, amikor - RequiredVersion nem. Ha - RequiredVersion van megadva, és egy előzetes verzióját, a parancs - AllowPrerelease kell adni. 
...
### <a name="save-modulepsgetsave-modulemd"></a>[Mentés-modul](./psget_save-module.md)
### <a name="update-modulepsgetupdate-modulemd"></a>[Frissítés-modul](./psget_update-module.md)
