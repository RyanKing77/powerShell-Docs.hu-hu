...
Ez a cikk ismerteti a helyi számítógép parancsfájlok hibakeresése a Windows PowerShell integrált parancsfájlkezelési környezet (ISE) visual hibakeresési szolgáltatások segítségével.
...
| **Átlépés** | Az aktuális utasítás végrehajtása, és majd leállítja a következő utasításnál. Ha az aktuális utasítás függvény vagy parancsfájl hívást, majd a hibakereső a teljes függvény vagy parancsfájl hajt végre, és leállítja a függvény hívása után a következő utasításnál. | Nyomja le az ENTER **F10** vagy a a **Debug** menüben kattintson a **Átlépés**, vagy írja be a konzol ablaktáblájában **V** nyomja le az ENTER **ENTER**. |
