...
---
# <a name="collecting-information-about-computers"></a>Számítógépekkel kapcsolatos információk gyűjtése
...
A metaadatok kiszűrésére segítségével (|) csővezeték-kezelőt a Get-WmiObject parancs küldése **Select-Object - tulajdonság [a – z]***.
