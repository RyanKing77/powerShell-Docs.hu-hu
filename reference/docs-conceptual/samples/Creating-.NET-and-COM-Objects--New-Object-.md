...
### <a name="storing-objects-in-variables"></a><span data-ttu-id="6da51-123">Objektumok tárolása változókban</span><span class="sxs-lookup"><span data-stu-id="6da51-123">Storing Objects in Variables</span></span>
