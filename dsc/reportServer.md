...
---
# <a name="using-a-dsc-report-server"></a>A DSC-jelentés kiszolgálóval
...
- [Konfigurációs nevek használatával lekéréses ügyfél beállítása](pullClientConfigNames.md)
