...
Ellenőrizze az erőforrás-séma (*. schema.mof) fájlt. Használhatja a [DSC erőforrás Designer](https://www.powershellgallery.com/packages/xDSCResourceDesigner/1.12.0.0) fejlesztése és tesztelése a séma segítségével.
...
Ezenkívül használjon **Test-xDscResource** és **Test-xDscSchema** parancsmagjait [DSC erőforrás Designer](https://www.powershellgallery.com/packages/xDSCResourceDesigner/1.12.0.0) automatikusan ellenőrizhető, hogy az erőforrások és a séma:
...
- Hiba: Hibaüzenetek legnagyobb problémája, hogy azok milyen gyakran nem létezik, ezért ügyeljen arra, hogy vannak-e.
- Könnyen áttekinthető: Emberi olvasható, nem homályos hibakódok
- Pontos: Mi az, hogy pontosan a probléma leírása
- Vélelmezett: Tanácsadás a probléma megoldása
- Udvarias: Nem felhasználó blame vagy őket úgy hibás
