...
---
# <a name="role-based-authorization-configuration-schema"></a>A szerepköralapú hitelesítés konfigurációs sémája

A [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) minta XML-fájlokat használja a hitelesítési szabályzatának konfigurálása. A következő XSD e fájlok esetében használatos sémát határozza meg.
