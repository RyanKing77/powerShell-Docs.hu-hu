...
ms.locfileid: "56851407"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="591c0-102">A szerepköralapú hitelesítés konfigurációs sémája</span><span class="sxs-lookup"><span data-stu-id="591c0-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="591c0-103">A [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) minta XML-fájlokat használja a hitelesítési szabályzatának konfigurálása.</span><span class="sxs-lookup"><span data-stu-id="591c0-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="591c0-104">A következő XSD e fájlok esetében használatos sémát határozza meg.</span><span class="sxs-lookup"><span data-stu-id="591c0-104">The following XSD defines the schema used for these files.</span></span>
