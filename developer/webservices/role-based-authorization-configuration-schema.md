---
title: Szerepkör-alapú hitelesítést konfigurációs séma |} A Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62080543"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="647e4-102">A szerepköralapú hitelesítés konfigurációs sémája</span><span class="sxs-lookup"><span data-stu-id="647e4-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="647e4-103">A [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) minta XML-fájlokat használja a hitelesítési szabályzatának konfigurálása.</span><span class="sxs-lookup"><span data-stu-id="647e4-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="647e4-104">A következő XSD e fájlok esetében használatos sémát határozza meg.</span><span class="sxs-lookup"><span data-stu-id="647e4-104">The following XSD defines the schema used for these files.</span></span>
