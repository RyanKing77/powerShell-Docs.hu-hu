...
---
# <a name="deploying-a-management-odata-web-service"></a>Egy Management OData webszolgáltatás üzembe helyezése

Miután végrehajtotta a lépéseket egy felügyeleti OData webszolgáltatást létrehozásához szükséges, azt telepítenie kell az IIS-ben webalkalmazásként.

## <a name="deploying-the-web-service"></a>A web Service szolgáltatásának telepítése

A következő lépéseket a felügyeleti OData web Service szolgáltatásának telepítése.

1. Hozzon létre egy könyvtárat, a webes alkalmazás az IIS alatti `WWWRoot` könyvtár.

2. Másolja az MOF séma fájlt az XML-séma fájlt az Exportálás DLL-ek a [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) és [System.Management.Automation.Remoting.Pssessionconfiguration](/dotnet/api/System.Management.Automation.Remoting.PSSessionConfiguration) felületek, és a web.config fájlban, az alkalmazás könyvtárába.

3. Hozzon létre egy helyhez.

4. Létrehozhat és konfigurálhat egy alkalmazáskészlet.

5. Konfigurálja a hely hitelesítését.

6. Konfigurálja a tűzfalat.

7. Indítsa el a helyet.

Az alábbi Windows PowerShell-parancsfájlok bemutatják, hogyan lehet egy felügyeleti OData web Service szolgáltatásának telepítése.
