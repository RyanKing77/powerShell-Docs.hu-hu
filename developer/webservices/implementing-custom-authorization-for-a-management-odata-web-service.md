...
A következő példában létrehozunk egy osztályt, amely elemzi az XML-fájlt az engedélyezési házirend.
...
```
 ...
 A következő osztályok rendre jelölik csoportokat és felhasználókat.
