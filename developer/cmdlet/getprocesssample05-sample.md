...
---
# <a name="getprocesssample05-sample"></a>GetProcessSample05 – minta

Ez a példa bemutatja egy a Get-Proc parancsmag teljes verzióját.

## <a name="how-to-build-the-sample-using-visual-studio"></a>Hogyan hozhat létre a mintát a Visual Studio használatával.

1. Nyissa meg a Windows Intézőt, és keresse meg a mintákat a könyvtárban a GetProcessSample05 könyvtárát.

   A Windows PowerShell 2.0 SDK telepítve van, és keresse meg a GetProcessSample05 mappát. Az alapértelmezett hely a C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
3. Az a **összeállítása** menüjében válassza **megoldás fordítása**.
   ...
   A könyvtár a minta az alapértelmezett \bin vagy \bin\debug könyvtárakat a lesz felépítve.
...
- Pozíciók paraméterek megadása.

- Adja meg, hogy a paraméterek az a folyamat bemeneti is eltarthat. A bemeneti elvégezhet egy objektum vagy egy értéket egy tulajdonságot egy objektum, amelynek tulajdonság neve megegyezik a paraméter neve.

- A bemeneti paraméter egy ellenőrző attribútuma deklaráló.

- Hibák és kivételek kezelése.

- Írás hibakeresési üzeneteket.

## <a name="example"></a>Példa

Ez a példa bemutatja, hogyan hozhat létre olyan parancsmagot, amely a megadott folyamatok listáját jeleníti meg.
