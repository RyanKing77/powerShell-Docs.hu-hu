...
Ez a példa bemutatja, hogyan támogatják a feladatok parancsmagok írásakor. Ha azt szeretné, hogy a felhasználók számára, hogy futtassa a parancsmagot háttérfeladatként, meg kell adnia a kódot az alábbi eljárásban leírtak. Háttér-feladatokkal kapcsolatos további információkért lásd: [a háttérben futó feladatok](./background-jobs.md).

## <a name="to-support-jobs"></a>Feladatok támogatása

1. Adja meg egy `AsJob` váltson paramétert, hogy a felhasználó eldöntheti, a parancsmag futtatása feladatként.

    Az alábbi példa bemutatja az-AsJob paraméter nyilatkozatot.
...
2. Hozzon létre egy objektumot származó a [System.Management.Automation.Job](/dotnet/api/System.Management.Automation.Job) osztály. Ez az objektum egy egyéni feladatobjektumot, vagy egy Windows PowerShell, a megadott feladat objektum lehet például egy [System.Management.Automation.Pseventjob](/dotnet/api/System.Management.Automation.PSEventJob) objektum.

    Az alábbi példa bemutatja egy egyéni feladatobjektumot.
...
4. Egyéni feladat objektumok a feladat osztály megvalósításához.
...
Az alábbi mintakód bemutatja a kódot egy **Get-Proc** parancsmagot, amely lekérheti a folyamatok cégen belül vagy a háttérfeladat használatával.
