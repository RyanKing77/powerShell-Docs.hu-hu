---
title: GetProc05 (VB.NET) mintakód |} A Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "58056413"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="8f8d4-102">GetProc05 (VB.NET) Sample Code – mintakód</span><span class="sxs-lookup"><span data-stu-id="8f8d4-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="8f8d4-103">Íme a GetProc05 parancsmagra teljes VB.NET kódját.</span><span class="sxs-lookup"><span data-stu-id="8f8d4-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="8f8d4-104">Lásd még:</span><span class="sxs-lookup"><span data-stu-id="8f8d4-104">See Also</span></span>

[<span data-ttu-id="8f8d4-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="8f8d4-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)