...
ms.locfileid: "56845065"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="70fb6-102">GetProc05 (VB.NET) Sample Code – mintakód</span><span class="sxs-lookup"><span data-stu-id="70fb6-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="70fb6-103">Íme a GetProc05 parancsmagra teljes VB.NET kódját.</span><span class="sxs-lookup"><span data-stu-id="70fb6-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="70fb6-104">Lásd még:</span><span class="sxs-lookup"><span data-stu-id="70fb6-104">See Also</span></span>

[<span data-ttu-id="70fb6-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="70fb6-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)