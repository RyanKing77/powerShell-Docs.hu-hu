...
---
# <a name="runspace02-vbnet-code-sample"></a>Runspace02 (VB.NET) – Kódminta

Íme a Runspace02 minta VB.NET forráskódját. Ebben a példában a [System.Management.Automation.Runspaceinvoke](/dotnet/api/System.Management.Automation.RunspaceInvoke) végrehajtásához az osztály a `Get-Process` parancsmag szinkron módon történik. Az eredmények megjelennek egy vezérlő majd használhatók a Windows Forms- és adatkötés.
