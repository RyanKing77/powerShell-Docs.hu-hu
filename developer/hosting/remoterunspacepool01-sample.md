...
---
# <a name="remoterunspacepool01-sample"></a>RemoteRunspacePool01 – minta

Ez a példa bemutatja, hogyan hozható létre egy távoli futási teret készletet, és hogyan egyidejű futtatását több parancs a készlet használatával.
...
- Fut a [Get-Process](/powershell/module/Microsoft.PowerShell.Management/Get-Process) és [Get-Service](/powershell/module/microsoft.powershell.management/get-service) parancsmagok által egyidejűleg távoli futási teret tárolókészletet használja.

- A távoli futási teret készlet kiadni a távoli kapcsolat bezárása.
