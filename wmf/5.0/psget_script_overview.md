...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="891ce-102">PowerShell-parancsfájl felderítési, telepítés és kezelés PowerShellGet az</span><span class="sxs-lookup"><span data-stu-id="891ce-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="891ce-103">A WMF 5.0 RTM verzióban PowerShellGet kapott hozzá megosztása szolgáltatás PowerShell parancsfájlt.</span><span class="sxs-lookup"><span data-stu-id="891ce-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="891ce-104">A következő új parancsmagok a PowerShellGet modul támogatásához a PowerShell-parancsfájlok hozzáadódnak.</span><span class="sxs-lookup"><span data-stu-id="891ce-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="891ce-105">Parancsfájl megosztási parancsmagok szintaxisa:</span><span class="sxs-lookup"><span data-stu-id="891ce-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
